...
| Directory | Purpose |
|-----------|---------|
| `raw/` | Original, unmodified source Excel files (7 files). Never edit files in this directory. |
...
| `HPG_intraday_ticks.xlsx` | HPG intraday tick-level matched trades | `fact_intraday_matching` |
